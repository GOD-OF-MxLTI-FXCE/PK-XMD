...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "pk~IYx0ja5J#Guh-ehDUXLxaWVUB68AZujNYBrdAg1KV0MvI5ow3h7w",
...
STICKER_NAME: process.env.STICKER_NAME || "P ム P Ｕ",
CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,🧡,💛,💚,💙,💜,🤎,🖤,🤍",
DELETE_LINKS: process.env.DELETE_LINKS || "true",
OWNER_NUMBER: process.env.OWNER_NUMBER || "50932818924",
OWNER_NAME: process.env.OWNER_NAME || "𝛸_𝛸𝑈𝛮𝛫𝛮𝛩𝑊𝛮",
